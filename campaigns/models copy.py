...
class Campaign(models.Model):
    ...
    def _get_unsubscribe_url(self, email):
        ...
        return f"{settings.SITE_URL}{reverse('subscriber:unsubscribe', args=[signed_email])}"
    ...
    def get_progress_data(self):
        ...
        try:
            ...
            return {
                ...
                'click_count': self.get_click_count(),  # Add your logic for click count here
                'bounce_count': self.get_bounce_count(),  # Add your logic for bounce count here
                'unsubscribe_count': self.get_unsubscribe_count() 
            }
        except Exception as e:
